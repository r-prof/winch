...
The libc function [`execinfo()`](https://www.gnu.org/software/libc/manual/html_node/Backtraces.html) was a first obvious candidate.
It works well enough on mainstream Linux, but not on Windows.
Also, function names were not discovered reliably.

The libunwind library supports similar functionality and discovers function names more reliably.
...
The [libbacktrace library](https://github.com/ianlancetaylor/libbacktrace), part of GCC and also available standalone, seems to give slightly worse results for the detection of function names.
...
FIXME: What is http://www.nynaeve.net/?p=99
